"""
CATAP Machine Area Module

This module defines a base classes specifying the machine area of an object.

Classes:
    - :class:`~CATAP.common.constants.machine.area.MachineArea`: Machine area name.
"""
...
class MachineArea(BaseModel):
    """
    Base class for setting the machine area of an object (see :mod:`~CATAP.common.constants.areas`).
    """
...
def _string_to_machine_area(area: str = None) -> MachineArea:
    """
    Convert string to :class:`~CATAP.common.machine.area.MachineArea` type.

    :param area: Name of area as string
    :type area: str

    :returns: String as :class:`~CATAP.common.machine.area.MachineArea`
    """
    if area is None:
